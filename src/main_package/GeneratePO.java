...
public class GeneratePO {
	public static JFrame generatePO  = new JFrame();
	...
	public static void createPOWindow(){
		...
		generatePO.setExtendedState(generatePO.getExtendedState() | JFrame.MAXIMIZED_BOTH);
		generatePO.add(panel);
		...
		JButton generatePO = new JButton("Generate PO");
		generatePO.setFont(new Font(Main.fonttype, Font.PLAIN, 15));
		generatePO.setBounds(950,850,150,50);
		generatePO.setVisible(true);
		panel.add(generatePO);
		generatePO.addActionListener (new generatePO());
	...
	static class generatePO  implements ActionListener {
